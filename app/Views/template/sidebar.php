    ...
    <div class="px-3 py-3 lg:px-5 lg:pl-3">
        <div class="flex items-center justify-between">
            ...
            <div class="flex items-center justify-start">
                ...
                <span class="self-center text-xl font-bold text-green-800 sm:text-2xl whitespace-nowrap"> Bank Sampah E-cogreen </span>
                </a>
            </div>

            <div class="flex items-center">
                <span class="flex items-center align-middle font-semibold text-green-800 text-m m-1 "> Admin </span>
                <div class="w-8 h-8 flex items-center justify-center rounded-full bg-green-800 ">
...
<aside id="logo-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen pt-20 transition-transform -translate-x-full bg-white border-r border-gray-200 sm:translate-x-0" aria-label="Sidebar">
   <div class="h-full px-3 pb-4 overflow-y-auto bg-white">
      <ul class="space-y-2 font-medium">
        <li>
            <a href="/" class="flex items-center p-2 text-gray-900 rounded-lg hover:bg-gray-100 <?= url_is('/') ? 'bg-green-800 text-white hover:bg-green-800' : ''; ?>">
